export const Icons = (props) => {
  return (
    <div className="  w-20 h-20 border border-gray-500    hover:bg-gray-700 rounded-md bg-black flex flex-col items-center justify-center lg:h-44 lg:w-44 lg:p-12  ">
